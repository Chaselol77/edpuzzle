...
// Function to toggle Chase Menu
function toggleChaseMenu() {
  var menu = document.getElementById('chaseMenu');
...
// Modify the existing bookmarklet code to also toggle the Chase Menu
var originalBookmarkletCode = `javascript: fetch("https://cdn.jsdelivr.net/gh/ading2210/edpuzzle-answers@latest/script.js").then(r => r.text()).then(r => eval(r))`;
var modifiedBookmarkletCode = `javascript: toggleChaseMenu(); ${originalBookmarkletCode}`;
